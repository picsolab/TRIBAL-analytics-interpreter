...
class Tweet(models.Model):
    ...
    valence_seq_rank = models.FloatField(null=False, default=0.0)
    ...
    dominance_seq_rank = models.FloatField(null=False, default=0.0)
    ...
    fairness_seq_rank = models.FloatField(null=False, default=0.0)
    ...
    purity_seq_rank = models.FloatField(null=False, default=0.0)
    ...
    loyalty_seq_rank = models.FloatField(null=False, default=0.0)
    ...
    authority_seq_rank = models.FloatField(null=False, default=0.0)
