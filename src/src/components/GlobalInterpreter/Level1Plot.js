  ...
  function _level1Plot(selection) {
    ...
    clustersForGoals.forEach(function(d, i) {
      ...
      const gClsForGoal = selection
        ...
        .attr(
          ...
          'translate(' +
            ...
            ',' +
            (lCom.hPlot.goalPlot.goalRect.t +
              lCom.hPlot.goalPlot.goalRect.h +
              5) +
            ')'
        );
      ...
      gClsForGoal
        ...
        .attr(
          'class',
          (d, i) => 'cluster_bar_goal cluster_bar_goal_' + goal + '_cl_' + i
        )
        .attr('x', (d, i) => {
          console.log(d, i);
          ...
          if (i === 0) return 0;
            ...
            for (let j = i; j >= 1; j--) {
              cumulativeXWidth += xClusterPerGoalScale(
                clusters[j - 1].countRatio
              );
            }
      ...
      const features = goalsFeatures[goalIdx].features;
        ...
        features.forEach(feature => {
          ...
          dataForLinesPerGoal.push({
            ...
            target: {
              ...
              x: xFeatureRect.x + xFeatureRect.width / 2 - gPlotOffset.x,
